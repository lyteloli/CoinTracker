...
class Neko:
    ...
    async def build_text(self, text: str, user: types.User, no_formatting: bool = False,
        ...
        :param obj: A message or call object
        ...
        if data is None:
            raise RuntimeError(f'{text} does not exist in {lang}!')
    ...
    async def delete_markup(self, user_id: int):
        ...
        message = await self.bot.send_message(chat_id=user_id, text='Please wait, looking for information',
